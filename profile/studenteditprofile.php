...
<div class="edit-profile-container">
    <aside class="sidebar">
        <h2>EDIT PROFILE</h2>
        <!-- Content here -->
        <a href="studentprofile.php" class="back-button">
    ...
    <section class="profile-form">
        ...
        <form>
            ...
            <div class="form-actions">
                ...
                <a href="../studentdashboard/studentdashboard.php" class="button">Update</a>
                <a href="studentprofile.php" class="button">Cancel</a>
            </div>
        </form>
    </section>
</div>
