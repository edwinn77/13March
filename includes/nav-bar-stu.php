...
<body>
    <header class="dashboard-header">
        <div class="profile-icon" id="profile-icon">
            <img src="../Images/student-icon.svg" alt="Profile">
        </div>
        <nav class="dashboard-nav">
            <ul>
                <li><a href="../studentdashboard/studentdashboard.php#dashboard-section">HOME</a></li>
                <li><a href="../studentdashboard/studentdashboard.php#about-section">ABOUT US</a></li>
                <li><a href="../studentdashboard/studentdashboard.php#contact-section">CONTACT</a></li>
            </ul>
        </nav>
    </header>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <div class="sidebar-content">
            <img src="../Images/student-icon.svg" alt="Nur Mariana" class="sidebar-profile-picture">
            <h2>SITI SUKI</h2>
            <p class="admin-email">Student | suki@gmail.com</p>
            <hr class="sidebar-divider">
            <ul>
                <li><a href="../profile/studentprofile.php" class="sidebar-link">Profile</a></li>
                <li><a href="../payment/studentpayment.php" class="sidebar-link">Payment</a></li>
                <li><a href="../evalution/studentevalution1.php" class="sidebar-link">Evaluation</a></li>
